    ...
    for i, file_name in enumerate(file_names):
        ...
        if file_name_str not in name_dict:
            ...
            os.rename(os.path.join(folder_path, file_name),
                      os.path.join('E:\\img_test\\img_test\\无班级\\', file_name_str + ext))
        else:
            ...
            try:
                print(os.path.join(folder_path, file_name) + "==>" + os.path.join(output_path,
                                                                                  name_dict[file_name_str] + ext))
                os.rename(os.path.join(folder_path, file_name),
                          os.path.join(output_path, name_dict[file_name_str] + ext))
